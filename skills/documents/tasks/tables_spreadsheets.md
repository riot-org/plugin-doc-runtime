...
```bash
"$RUNTIME_BIN_DIR/python3" scripts/xlsx_to_docx_table.py /mnt/data/input.xlsx /mnt/data/table.docx --title "Table: Results"
```
...
```bash
"$RUNTIME_BIN_DIR/python3" scripts/docx_table_to_csv.py /mnt/data/input.docx --table_index 0 --out /mnt/data/table0.csv
```
