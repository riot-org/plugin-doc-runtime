...
```bash
"$RUNTIME_BIN_DIR/python3" scripts/internal_nav.py /mnt/data/input.docx --out /mnt/data/with_static_toc.docx
```
...
```bash
"$RUNTIME_BIN_DIR/python3" scripts/insert_toc.py /mnt/data/input.docx --out /mnt/data/with_toc.docx
```
...
```bash
"$RUNTIME_BIN_DIR/python3" render_docx.py /mnt/data/with_toc.docx --output_dir /mnt/data/out
```
