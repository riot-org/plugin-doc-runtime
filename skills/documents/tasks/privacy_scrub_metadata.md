...
## Scrub a doc
```bash
"$RUNTIME_BIN_DIR/python3" scripts/privacy_scrub.py input.docx --out scrubbed.docx
```

## Verify
```bash
"$RUNTIME_BIN_DIR/python3" render_docx.py scrubbed.docx --output_dir out_scrubbed
```
