...
```bash
"$RUNTIME_BIN_DIR/python3" scripts/a11y_audit.py input.docx --fix_table_headers first_row --out a11y_fixed.docx
```
...
```bash
"$RUNTIME_BIN_DIR/python3" render_docx.py a11y_fixed.docx --output_dir out_a11y
```
